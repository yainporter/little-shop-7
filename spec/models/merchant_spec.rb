  ...
  describe "instance methods" do
    ...
    describe "#top_5_popular_items" do
      it "only counts invoices with at least 1 successful transaction" do
        ...
        lance_invoice_1 = Invoice.create!(customer_id: lance.id, status: 0)
        lance_invoice_2 = Invoice.create!(customer_id: lance.id, status: 0)
        lance_invoice_3 = Invoice.create!(customer_id: lance.id, status: 0)
        lance_invoice_4 = Invoice.create!(customer_id: lance.id, status: 0)
        lance_invoice_5 = Invoice.create!(customer_id: lance.id, status: 0)

        #Invoice 1
        InvoiceItem.create!(item_id: book.id, invoice_id: lance_invoice_1.id, quantity: 4, status: 1, unit_price: 1000) #4000
        ...
        InvoiceItem.create!(item_id: sunglasses.id, invoice_id: lance_invoice_3.id, quantity: 2, status: 1, unit_price: 25000)
